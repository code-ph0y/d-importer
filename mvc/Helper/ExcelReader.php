...
class ExcelReader
{
	...
	protected $encodings = array(1251 => 'CP1251');
	protected $codePage;
	...
	/**
	 * Get the value of a cell using the Column and Row
	 *
	 * @param  mixed  $row     The Row
	 * @param  mixed  $col     The Column
	 * @param  integer  $sheet The Sheet
	 * @return mixed
	 */
	...
	public function read($sFileName)
	{
		...
		if($res === false) {
			...
			if($this->_ole->error == 1) {
				// bad file
				throw new RuntimeException('The filename ' . $sFileName . ' is not readable');
			}
	...
	private function _parse()
	{
		...
		if (
			($this->version != SPREADSHEET_EXCEL_READER_BIFF8) &&
	...
	private function _encode($string, $from = 'UTF-16LE')
	{
		$result = $string;
